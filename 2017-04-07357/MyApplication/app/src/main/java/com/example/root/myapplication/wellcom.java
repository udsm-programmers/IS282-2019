    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forget.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(wellcom.this,forgotpassword.class);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(wellcom.this,student.class);
                startActivity(intent);
            }
        });
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent intent = new Intent(wellcom.this,choose.class);
                    startActivity(intent);
                }
                else if(edit1.getText().toString().equals("Admin")&&(edit2.getText().toString().equals("123456"))) {
                    Intent intent= new Intent(wellcom.this,users.class);
                    startActivity(intent);
