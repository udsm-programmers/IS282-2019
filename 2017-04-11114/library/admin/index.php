...
$ret=mysqli_query($connection,"SELECT * FROM admin WHERE username='$DB_USER' and password='$DB_PASS'");
...
$extra="index.php";
$host  = $DB_SERVER['HTTP_HOST'];
$uri  = rtrim(dirname($DB_SERVER['PHP_SELF']),'/\\');
header("location:http://localhost/library/home.php");
exit();
}
}
			...
			<div class="container">
				...
				<div class="nav-collapse collapse navbar-inverse-collapse">
					...
					<ul class="nav pull-right">
						...
						<li><a href="http://localhost/library/">
						Back to Portal
